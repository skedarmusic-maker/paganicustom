      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 text-white/70 font-sans text-lg md:text-xl font-light">
              <p>
              ...
              <blockquote className="border-l-4 border-primary bg-white/5 pl-6 pr-4 py-4 italic text-white/60 text-base md:text-lg backdrop-blur-sm -skew-x-6">
